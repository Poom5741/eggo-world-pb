...
migrate((app) => {
  const collection = new Collection({
    ...
    "viewRule": "user_id = @request.auth.id || @request.auth.id != \"\" && user_id.referrer_id = @request.auth.id",
    "createRule": "",
