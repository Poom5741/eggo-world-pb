  ...
  return (
    <input
      ...
      className={cn(
        ...
        variant === 'default' && 'rounded-md shadow-xs focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]',
        variant === 'clay' && 'rounded-clay shadow-clay-sm focus:shadow-clay-md transition-shadow border-primary/20 focus:border-primary',
