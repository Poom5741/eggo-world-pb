...
/**
 * Error boundary สำหรับ Dashboard page
 * แสดงเมื่อเกิดข้อผิดพลาดในการโหลดข้อมูลของ dashboard
 */
    ...
    <LayoutWithoutNav>
      <div className="max-w-6xl mx-auto py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <h1 className="text-5xl font-pixel-style text-primary mb-2">Dashboard</h1>
            <p className="text-on-surface-variant max-w-md">
              Your command center. Track your balance, eggs, and referrals.
            </p>
          </div>
        </div>
