  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[var(--primary-container)] opacity-20 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-[10%] right-[-5%] w-[40%] h-[40%] bg-[var(--tertiary-container)] opacity-20 rounded-full blur-[100px]"></div>
        <div className="absolute top-[40%] right-[10%] w-[30%] h-[30%] bg-[var(--secondary-container)] opacity-15 rounded-full blur-[80px]"></div>
      </div>
      ...
      <main className="pt-20 pb-24 lg:pb-0">
        ...
        <section className="relative px-6 py-20 lg:py-32 flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto overflow-hidden">
          <div className="lg:w-1/2 space-y-8 z-10 text-center lg:text-left">
            <div className="inline-block px-6 py-2 bg-[var(--tertiary-container)] text-[var(--on-tertiary-container)] rounded-full font-bold text-sm tracking-widest uppercase">
              Season 1: Genesis
            </div>
            <h1 className="text-6xl md:text-8xl font-black text-[var(--on-surface)] leading-tight tracking-tighter">
              HATCH YOUR <span className="text-[var(--primary)] italic">DESTINY.</span>
            </h1>
            <p className="text-lg md:text-xl text-[var(--on-surface)]-variant max-w-lg mx-auto lg:mx-0">
          ...
          <div className="lg:w-1/2 relative mt-16 lg:mt-0">
            <div className="relative w-full aspect-square max-w-lg mx-auto bg-[var(--surface)]-container-highest rounded-full shadow-[inset_0_4px_12px_rgba(0,0,0,0.1)] flex items-center justify-center p-8">
              <img 
              ...
              />
              <div className="absolute -top-10 -right-10 bg-[var(--secondary-container)] p-6 rounded-[2rem] shadow-xl transform rotate-12">
                <span className="material-symbols-outlined text-4xl text-[var(--on-secondary)]-container" style={{fontVariationSettings: "'FILL' 1"}}>egg</span>
              </div>
              <div className="absolute bottom-4 -left-12 bg-[var(--tertiary-container)] p-6 rounded-[2rem] shadow-xl transform -rotate-12">
                <span className="material-symbols-outlined text-4xl text-[var(--on-tertiary-container)]" style={{fontVariationSettings: "'FILL' 1"}}>restaurant</span>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* NFT Showcase Bento */}
        <section className="bg-[var(--surface)]-container-low py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
              <div className="space-y-4">
                <h2 className="text-4xl md:text-5xl font-black text-[var(--on-surface)]">Genesis Collection</h2>
                <p className="text-[var(--on-surface)]-variant max-w-md">Discover the first wave of Eggo elements and rare food clusters.</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="md:col-span-2 bg-[var(--surface)] p-8 rounded-[2.5rem] shadow-lg flex flex-col justify-between group overflow-hidden">
                <div className="relative">
                  ...
                  <div className="absolute top-0 right-0 bg-[var(--primary)] text-[var(--on-primary)] px-4 py-1 rounded-full text-sm font-bold">LEGENDARY</div>
                </div>
                <div className="pt-8">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <button className="material-symbols-outlined bg-[var(--surface)]-container-highest p-3 rounded-full" aria-label="Add to cart">shopping_cart</button>
                  </div>
                </div>
              </div>

              <div className="bg-[var(--surface)]-container-high p-6 rounded-[2rem] shadow-md flex flex-col">
                ...
                <p className="text-sm text-[var(--on-surface)]-variant mt-2">+25 Energy</p>
                <div className="mt-auto pt-4 flex justify-between items-center">
                  <span className="font-bold">0.05 ETH</span>
                  <button className="text-[var(--primary)] font-bold">Buy Now</button>
                </div>
              </div>
              ...
              <div className="bg-[var(--surface)]-container-high p-6 rounded-[2rem] shadow-md flex flex-col">
                ...
                <p className="text-sm text-[var(--on-surface)]-variant mt-2">+50 Vitality</p>
                <div className="mt-auto pt-4 flex justify-between items-center">
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-[var(--on-surface)]-variant">Simple steps to master the EggoWorld ecosystem.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            <div className="hidden md:block absolute top-1/2 left-0 w-full h-1 bg-[var(--surface)]-container z-0 -translate-y-12"></div>

            <div className="relative z-10 flex flex-col items-center text-center space-y-6">
              <div className="w-24 h-24 bg-[var(--primary-container)] rounded-[2rem] shadow-xl flex items-center justify-center transform hover:rotate-6 transition-transform">
                <span className="material-symbols-outlined text-4xl text-[var(--on-primary)]-container" style={{fontVariationSettings: "'FILL' 1"}} aria-hidden="true">shopping_bag</span>
              </div>
              <div>
                <h3 className="text-2xl font-black">Buy Egg</h3>
                <p className="text-[var(--on-surface)]-variant text-sm mt-2">Acquire your first Genesis Egg from the marketplace.</p>
              </div>
            </div>

            <div className="relative z-10 flex flex-col items-center text-center space-y-6">
              <div className="w-24 h-24 bg-[var(--secondary-container)] rounded-[2rem] shadow-xl flex items-center justify-center transform hover:-rotate-6 transition-transform">
                <span className="material-symbols-outlined text-4xl text-[var(--on-secondary)]-container" style={{fontVariationSettings: "'FILL' 1"}} aria-hidden="true">restaurant</span>
              </div>
              <div>
                <h3 className="text-2xl font-black">Collect Food</h3>
                <p className="text-[var(--on-surface)]-variant text-sm mt-2">Complete daily quests to find high-energy snacks.</p>
              </div>
            </div>

            <div className="relative z-10 flex flex-col items-center text-center space-y-6">
              <div className="w-24 h-24 bg-[var(--tertiary-container)] rounded-[2rem] shadow-xl flex items-center justify-center transform hover:rotate-6 transition-transform">
                <span className="material-symbols-outlined text-4xl text-[var(--on-tertiary-container)]" style={{fontVariationSettings: "'FILL' 1"}} aria-hidden="true">volunteer_activism</span>
              </div>
              <div>
                <h3 className="text-2xl font-black">Feed</h3>
                <p className="text-[var(--on-surface)]-variant text-sm mt-2">Keep your Eggo full to unlock growth potential.</p>
              </div>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center space-y-6">
              ...
              <div>
                <h3 className="text-2xl font-black text-[var(--on-surface)]">Hatch</h3>
                <p className="text-[var(--on-surface)]-variant text-sm mt-2">Unlock a unique 3D creature with rare traits.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Features & Community */}
        <section className="py-24 px-6 bg-[var(--surface)]-container-highest">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/2 bg-[var(--surface)] p-12 rounded-[2rem] shadow-xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--secondary-container)] opacity-20 rounded-bl-full group-hover:scale-150 transition-transform duration-700"></div>
              <div className="relative z-10 space-y-6">
                <span className="material-symbols-outlined text-5xl text-[var(--secondary)]" style={{fontVariationSettings: "'FILL' 1"}} aria-hidden="true">group_add</span>
                <h2 className="text-4xl font-black">Referral Benefits</h2>
                <p className="text-lg text-[var(--on-surface)]-variant">Invite your friends to the nest. For every new hatchling, you earn 5% of their marketplace activity and exclusive &quot;Golden Omelette&quot; badges.</p>
                <button className="bg-[var(--secondary)] text-[var(--on-secondary)] px-8 py-3 rounded-full font-bold hover:scale-105 transition-transform">Copy Invite Link</button>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 bg-[var(--surface)] p-12 rounded-[2rem] shadow-xl border-4 border-dashed border-[var(--border)] relative overflow-hidden group">
              <div className="relative z-10 space-y-6">
                <span className="material-symbols-outlined text-5xl text-[var(--tertiary)]" style={{fontVariationSettings: "'FILL' 1"}} aria-hidden="true">event</span>
                <h2 className="text-4xl font-black">Community Events</h2>
                <p className="text-lg text-[var(--on-surface)]-variant">Join weekly Raids and Hatching Parties. Compete for the title of &quot;Master Breeder&quot; and win limited edition food drops.</p>
                <div className="flex items-center space-x-[-12px]">
                  <div className="w-12 h-12 rounded-full border-4 border-white bg-[var(--primary-container)] flex items-center justify-center font-bold z-10">JD</div>
                  <div className="w-12 h-12 rounded-full border-4 border-white bg-[var(--secondary-container)] flex items-center justify-center font-bold z-20">SK</div>
                  <div className="w-12 h-12 rounded-full border-4 border-white bg-[var(--tertiary-container)] flex items-center justify-center font-bold z-30">LM</div>
                  <div className="w-12 h-12 rounded-full border-4 border-white bg-[var(--surface)]-container-highest flex items-center justify-center text-xs font-bold z-40">+542</div>
                  <span className="ml-6 text-sm font-bold text-[var(--on-surface)]-variant">Active right now</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-32 px-6 text-center">
          <div className="max-w-4xl mx-auto bg-[var(--primary)] p-16 rounded-[2rem] shadow-[0_40px_100px_rgba(119,99,0,0.3)] relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              <h2 className="text-5xl md:text-7xl font-black text-[var(--on-primary)]">READY TO HATCH?</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <button className="bg-white text-[var(--primary)] px-12 py-5 rounded-[2rem] font-headline font-black text-2xl shadow-2xl hover:scale-105 transition-transform">
                  Join Discord
                </button>
