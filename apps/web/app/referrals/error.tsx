...
/**
 * Error boundary สำหรับ Referral page
 * แสดงเมื่อเกิดข้อผิดพลาดในการโหลดข้อมูลแนะนำเพื่อน
 */
    ...
    <LayoutWithoutNav>
      <div className="max-w-6xl mx-auto py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <h1 className="text-5xl font-pixel-style text-primary mb-2">My Referrals</h1>
