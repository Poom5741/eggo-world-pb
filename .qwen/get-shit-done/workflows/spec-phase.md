...
```bash
INIT=$(node "/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/templates/spec.md.
