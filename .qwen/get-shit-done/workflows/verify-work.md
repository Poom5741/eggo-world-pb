...
<template>
@/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/workflows/diagnose-issues.md
