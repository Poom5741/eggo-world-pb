...
```
Task(
  prompt="Read /Users/poom-work/tokenine/eggo-pocketbase/.qwen/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/templates/VALIDATION.md`
