...
<required_reading>
@/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/references/ai-frameworks.md
@/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/poom-work/tokenine/eggo-pocketbase/.qwen/agents/gsd-framework-selector.md for instructions.
...
```bash
cp "/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/poom-work/tokenine/eggo-pocketbase/.qwen/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/poom-work/tokenine/eggo-pocketbase/.qwen/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/poom-work/tokenine/eggo-pocketbase/.qwen/agents/gsd-eval-planner.md for instructions.
