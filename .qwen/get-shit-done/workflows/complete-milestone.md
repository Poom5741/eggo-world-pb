...
```bash
node "/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/templates/retrospective.md`.
