...
Key references:
- @/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/USER-PROFILE.md" "/Users/poom-work/tokenine/eggo-pocketbase/.qwen/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global QWEN.md" -- "Add profile to /Users/poom-work/tokenine/eggo-pocketbase/.qwen/QWEN.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/poom-work/tokenine/eggo-pocketbase/.qwen/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /Users/poom-work/tokenine/eggo-pocketbase/.qwen/QWEN.md"
...
```bash
BACKUP_PATH="/Users/poom-work/tokenine/eggo-pocketbase/.qwen/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/poom-work/tokenine/eggo-pocketbase/.qwen/commands/gsd/dev-preferences.md
  ✓ QWEN.md section       ./QWEN.md
  ✓ Global QWEN.md        /Users/poom-work/tokenine/eggo-pocketbase/.qwen/QWEN.md
```
