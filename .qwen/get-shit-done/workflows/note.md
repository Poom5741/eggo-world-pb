...
- **Global scope**: `/Users/poom-work/tokenine/eggo-pocketbase/.qwen/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/poom-work/tokenine/eggo-pocketbase/.qwen/notes/`)
...
2. Glob `/Users/poom-work/tokenine/eggo-pocketbase/.qwen/notes/*.md` (if directory exists) — global notes
...
Global (/Users/poom-work/tokenine/eggo-pocketbase/.qwen/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/poom-work/tokenine/eggo-pocketbase/.qwen/notes/` — works in any directory
