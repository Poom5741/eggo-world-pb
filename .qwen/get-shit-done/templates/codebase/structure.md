...
- Usage: Reference from command with `@/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/poom-work/tokenine/eggo-pocketbase/.qwen/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/poom-work/tokenine/eggo-pocketbase/.qwen/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
