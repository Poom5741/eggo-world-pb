...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-sdk query`. Use `node /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-sdk query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs
...
node \"/Users/poom-work/tokenine/eggo-pocketbase/.qwen/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
