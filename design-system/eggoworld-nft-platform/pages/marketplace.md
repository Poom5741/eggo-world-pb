  ...
  <main className="pt-20 pb-24">
    ...
    <section className="bg-gradient-to-b from-primary-container to-surface-container py-16 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="font-headline font-black text-5xl mb-4">Discover NFTs</h1>
...
<div className="flex flex-col md:flex-row gap-6">
  ...
  <aside className="w-full md:w-64 flex-shrink-0">
    <Card className="p-6 space-y-6">{/* Filter sections */}</Card>
  </aside>
...
<div className="flex items-center justify-between mb-6">
  <div className="text-on-surface-variant">
    ...
    of <span className="font-bold text-on-surface">{total}</span> results
  </div>
  ...
  <div className="p-5 space-y-4">
    ...
    <div className="grid grid-cols-2 gap-2">
      {attributes.slice(0, 2).map((attr) => (
        <div
          key={trait_type}
          className="bg-surface-container-high rounded-clay-sm px-3 py-2 text-center"
        >
...
<div className="space-y-6">
  ...
  <div>
    ...
    <div className="space-y-3">
      <Slider defaultValue={[min, max]} max={10} step={0.1} className="w-full" />
...
<Dialog>
  ...
  <DialogContent className="rounded-clay-xl shadow-clay-xl max-w-lg">
    <DialogHeader>
      ...
      <DialogDescription>Set your price and marketplace duration</DialogDescription>
    </DialogHeader>
    ...
    <div className="space-y-6 py-4">
      ...
      <div>
        ...
        <Input type="number" placeholder="0.00" step={0.01} className="mt-2" />
      </div>
    ...
    <DialogFooter>
      ...
      <Button variant="clay" onClick={handleSell}>
        List NFT
      </Button>
    </DialogFooter>
  </DialogContent>
...
```tsx
{
  query && (
    <div className="absolute top-full left-0 right-0 mt-2 bg-surface rounded-clay-lg shadow-clay-xl p-4 z-50">
      <div className="space-y-3">
        <div>
          <div className="text-xs font-bold text-on-surface-variant uppercase mb-2">
            Suggested Searches
          </div>
...
<div className="bg-surface rounded-clay-lg shadow-clay-md overflow-hidden">
  <div className="flex gap-4 p-4">
    <img
      src={image}
      alt={name}
      className="w-24 h-24 object-contain bg-surface-container-high rounded-clay-md"
    />
...
<Sheet>
  ...
  <SheetContent side="left" className="w-full max-w-xs overflow-y-auto">
    ...
    <div className="py-6 space-y-6">{/* Filter sections */}</div>
